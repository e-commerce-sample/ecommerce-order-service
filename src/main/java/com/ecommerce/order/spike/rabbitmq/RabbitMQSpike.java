...
//        });
        ...
        channel.basicPublish("32", "QUEUE_NAME", null, "daa".getBytes());
//
...
//                if (multiple) {
//                    logger.info("ack mutilpal" + seqNo);
//                } else {
//                    logger.info("ack non multipal" + seqNo);
//                }
//            }
//
...
//                channel.basicPublish("f23f2", "routin", false, MessageProperties.PERSISTENT_BASIC,
//                        "nop".getBytes());
//
//                Thread.sleep(5000);
//        channel.close();
